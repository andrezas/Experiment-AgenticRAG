...
uv run run_tests.py --config run_config/multi_test_config_book_8K.yaml
# uv run run_tests.py --config run_config/multi_test_config_book_16K.yaml
# uv run run_tests.py --config run_config/multi_test_config_book_32K.yaml
